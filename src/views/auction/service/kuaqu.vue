<template>
  <div style="position: relative;width:98%;paddingBottom:50px;">
    <!-- <el-form :inline="true" :model="formInline" class="demo-form-inline" style="marginTop:30px">
      ...
      >
        <el-table-column prop="shopName" label="主要内容" align="center"></el-table-column>
        <el-table-column prop="amount" label="区域"  align="center">
        </el-table-column>
  ...
  export default {
    data() {
      return {
        formInline:{},
        tableData: [{
          shopName: '军民融合体系工程研设计研究',
          amount: '青岛研究院-广州中山大学',
            successPayCount:'附研究报告',
        },
        {
          shopName: '军事人工智能协同创新研究',
          amount: '青岛研究院-上海深兰科技',
            successPayCount:'附研究报告',
        },
        {

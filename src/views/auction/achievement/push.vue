  ...
  <div style="width: 80%; margin: 0 auto">
    <el-form ref="form" :model="form" label-width="80px">
      <el-form-item label="成果名称:">
        <el-input v-model="form.achievementName" placeholder="请输入名称"></el-input>
      </el-form-item>
      <el-form-item label="成果类型:">
        <el-select
         v-model="form.resultsTypeId" 
         placeholder="请选择需求类型"
         :data="findByresultsTypeIdData"
         >
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      this.$api.technologyAchievement.release(formValues)
    },
    findByresultsTypeIdData () {
      
      const { data:findByresultsTypeIdData } = this.findByresultsTypeIdData()
      const genfindByresultsTypeIdData = this.genfindByresultsTypeIdData(findByresultsTypeId,'','')
    ...
    findByresultsTypeIdData () {
    return this.$api.tabResultsType.findByresultsTypeId ()
    },
  },
};
</script>
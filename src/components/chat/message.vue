<template>
  <div class="messagebox" v-show="activedKey[type]!= ''">
    ...
    <div class="messagebox-content" ref="msgContent" style="height:800px;paddingBottom:100px">
...
export default {
  ...
  methods: {
    ...
    customEmoji(value) {
      let url=require(`../../../static/faces/${value}`)
      // console.log(url,12312312)
      return `<img src="${url}" style="width:20px"/>`;
    },
